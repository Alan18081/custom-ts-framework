    ...
    UsersController.prototype.getUsers = function (token, id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.someService.findAll()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UsersController.prototype.createOne = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.someService.createOne(body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UsersController.prototype.updateOne = function (id, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.someService.updateOne(id, body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
