...
var Item = /** @class */ (function () {
    ...
    Item.prototype.getUsers = function (id) {
...
controllers.forEach(function (_a) {
    ...
    var methods = Reflect.getMetadata(METADATA_KEY.controllerMethod, target);
    var params = Reflect.getMetadata(METADATA_KEY.controllerParams, target);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, descriptor.value(args)];
                    case 1:
                        result = _a.sent();
                        res.send(result);
                        return [3 /*break*/, 3];
