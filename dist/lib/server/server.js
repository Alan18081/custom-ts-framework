...
var Server = /** @class */ (function () {
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        args = this.createArgs(req, res, next, params);
    ...
    Server.prototype.createArgs = function (req, res, next, params) {
    ...
    Server.prototype.createTables = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tables, _i, tables_1, table, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        tables = Reflect.getMetadata(constants_2.METADATA.TABLES, Reflect);
                        _i = 0, tables_1 = tables;
                        _a.label = 1;
                    case 1:
                        if (!(_i < tables_1.length)) return [3 /*break*/, 4];
                        table = tables_1[_i];
                        return [4 /*yield*/, helpers_1.createTable(table)];
                    case 2:
                        _a.sent();
