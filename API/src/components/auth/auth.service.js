...
let AuthService = class AuthService {
    constructor() {
        ...
        passport.use(new passport_jwt_1.Strategy(this.options, (payload, done) => __awaiter(this, void 0, void 0, function* () {
            try {
                const message = new message_1.Message(communication_codes_1.CommunicationCodes.AUTH_BY_TOKEN, payload);
                const user = yield message_broker_1.messageBroker.sendMessageAndGetResponse(queues_enum_1.QueuesEnum.AUTH_SERVICE, message);
            }
            catch (e) {
                done(e);
            }
