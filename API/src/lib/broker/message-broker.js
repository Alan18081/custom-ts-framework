...
const event_emitter_1 = require("../../../../Common/event-emitter");
exports.messageBroker = new class {
    ...
    sendMessageAndGetResponse(queue, message) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.channel.assertQueue(queue);
            const id = uid();
            yield this.sendMessage(queue, message, { correlationId: id, replyTo: queues_enum_1.QueuesEnum.RPC_API, contentType: 'application/json' });
    ...
    subscribe(id) {
        return new Promise((resolve) => {
            event_emitter_1.eventEmitter.once(id, message => {
                resolve(message);
            });
        });
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.channel.assertQueue(queues_enum_1.QueuesEnum.RPC_API);
            this.channel.consume(queues_enum_1.QueuesEnum.RPC_API, msg => {
                if (msg) {
                    try {
                        event_emitter_1.eventEmitter.emit(msg.properties.correlationId, this.parseMessage(msg.content));
                    }
                    catch (e) {
                    }
                }
